...
The game is an Endless Runner which can be played in an visual, audio and haptic game mode. 
...
To see the project as a hole you need Unity version 2020.2.2f1 and then import this folder as a new project. 
...
the slide obstacle, and before the obstacle you will hear a sound indicating you to perform an action. 
